...
#Team - Dillusioners
#Word - including
#Info - This program checks how many times a character or a group of characters appear in a file
import os
#User Display
print("###########################################################################################################################")
print(" This program is based on data analysis to check how many words include a character or group of characters in a txt file ")
print("###########################################################################################################################")
